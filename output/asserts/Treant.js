...
(function () {
   ...
   Tree.prototype = {
      ...
      handleOverflow: function (treeWidth, treeHeight) {
         var viewWidth =
               treeWidth < this.drawArea.clientWidth ? this.drawArea.clientWidth : treeWidth + this.CONFIG.padding * 2,
            viewHeight =
   ...
   TreeNode.prototype = {
      ...
      reset: function (nodeStructure, id, parentId, tree, stackParentId) {
         ...
         this.collapsable =
            nodeStructure.collapsable === false ? false : nodeStructure.collapsable || tree.CONFIG.node.collapsable;
